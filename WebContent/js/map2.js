...
function clicked(point) {
	...
	points = document.getElementById("selected_points");
	selected_points.push(""+point.lat()+";"+point.lng()+"#%");
	points.value = selected_points;
} 
...
function deleteMarkers() {
	...
	selected_points = [];
	 ...
	 document.getElementById("selected_points").value = '';
}
